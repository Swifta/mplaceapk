 ...
 */
public class SimilarDealsAdapter extends RecyclerView.Adapter<SimilarDealsAdapter.DealsViewHolder> {
    List<JSONParser> deals;
    private PopupMenu popupMenu;
    private Context context;
    private View view;

    public SimilarDealsAdapter(Context context, List<JSONParser> deals) {
        this.deals = deals;
