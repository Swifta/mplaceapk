...
import com.swifta.zenith.marketplace.Activities.AllAuctionActivity;
 ...
 */
public class SimilarAuctionsAdapter extends RecyclerView.Adapter<SimilarAuctionsAdapter.AuctionViewHolder> {
    ...
    public SimilarAuctionsAdapter(Context context, List<JSONParser> auctions) {
                        ...
                        if (!BaseNavigationDrawerActivity.SIGNED_IN) {
                            ...
                            switch (menuItem.getItemId()) {
                                case 1:
                                    ...
                                    AllAuctionActivity.displayWishlistCount();
                                    Snackbar.make(view, auctions.get(position).getProperty(Dictionary.dealTitle).toString()
                                            + "has been added to your bid", Snackbar.LENGTH_SHORT).show();
                                    return true;
                                default:
                                    return false;
                            }
