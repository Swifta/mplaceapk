 ...
 */
public class ProductCategoryFragment extends android.support.v4.app.Fragment {
    View v;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        noProducts = (TextView) v.findViewById(R.id.no_stores);
        ...
        categoryAdapter = new CategoryAdapter(getActivity(), categories, "ProductCategoryFragment");
    ...
    private void initializeCategories() {
        if (networkConnection.isInternetOn()) {
            Ion.with(this)
                    .load(Utility.HOST_VALUE + Utility.PRODUCT_CATEGORY_PATH_VALUE + "13.html")
                    .asJsonObject()
